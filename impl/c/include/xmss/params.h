...
#define XMSS_MAX_BDS_K    4U   /* max BDS retain parameter (K=0 or: K≥2, K<H, (H-K) even) */
...
/**
 * xmss_mt_params_from_name() - populate params from an XMSS-MT name string.
 *
